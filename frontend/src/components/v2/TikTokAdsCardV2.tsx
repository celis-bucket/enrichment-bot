...
interface TikTokAdsCardV2Props {
...
export function TikTokAdsCardV2({ activeAdsCount, adLibraryUrl, domain = '', feedback = [] }: TikTokAdsCardV2Props) {
  if (activeAdsCount == null) {
    return (
      <div className="bg-white rounded-2xl border border-melonn-purple-50 shadow-sm p-5">
        <h3 className="text-sm font-semibold text-melonn-navy font-heading mb-2">Anuncios en TikTok</h3>
        <p className="text-sm text-melonn-navy/40">No hay datos de anuncios en TikTok</p>
        {domain && <FeedbackPanel domain={domain} section="tiktok_ads" existingFeedback={feedback} />}
      </div>
    );
  }
  ...
  return (
    <div className="bg-white rounded-2xl border border-melonn-purple-50 shadow-sm p-5">
      <div className="flex items-center justify-between mb-3">
        <h3 className="text-sm font-semibold text-melonn-navy font-heading">Anuncios en TikTok</h3>
      ...
      <div className="text-center mb-3">
        ...
        <p className="text-xs text-melonn-navy/50 mt-1">Anuncios activos en TikTok Ads Library</p>
      </div>
