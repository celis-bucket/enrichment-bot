...
export function ContactCardV2({ contacts, contactName, contactEmail, companyLinkedin, numberEmployes, domain = '', feedback = [] }: ContactCardV2Props) {
  ...
  if (!hasContacts && !hasFallback && !hasCompanyInfo) {
    return (
      <div className="bg-white rounded-2xl border border-melonn-purple-50 shadow-sm p-5">
        <h3 className="text-sm font-semibold text-melonn-navy font-heading mb-2">Contactos y Empresa</h3>
        <p className="text-sm text-melonn-navy/40">No hay datos de contacto disponibles</p>
  ...
  return (
    <div className="bg-white rounded-2xl border border-melonn-purple-50 shadow-sm p-5">
      <h3 className="text-sm font-semibold text-melonn-navy font-heading mb-3">Contactos y Empresa</h3>
      ...
      <div className="space-y-2 mb-3">
        ...
        {numberEmployes != null && (
          <div className="flex items-center gap-2">
            <span className="text-melonn-navy/50 text-sm w-20 shrink-0">Empleados</span>
